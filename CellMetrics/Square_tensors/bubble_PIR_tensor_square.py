...
#Single neuron simulation - 120 neurons with varying current steps
N = 120
...
transitionCurrents = zeros((res,res,res,res))
		...
		#The excitatory term to each cell depends on the cell number - that way, implemented more efficiently as current steps down
                ...
                if (falseSpikes == 0):
                    ...
                    #No transition occured - current required is not enough, thus invalid
                        ...
                        print('Valid transition at ' + str(transitions[1]))
                    #For any other possible cases, label as invalid
                    else:
                        transitionCurrents[y,jj,ii,z] = +1
...
save('TC_square_tensor',transitionCurrents)
print("Saved!")
